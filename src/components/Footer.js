        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold">Aanjan Samaj</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              A spiritual organization dedicated to fostering spiritual growth, community service, 
              and promoting spiritual values for the betterment of humanity.
            </p>
            
            {/* Social Links */}
            <div className="flex space-x-4">
              <a href="#" className="text-gray-300 hover:text-spiritual-400 transition-colors">
